      ...
      <div className="h-[820px]">
        <div className="flex flex-row w-full h-[730px] gap-[84px] justify-center items-center">
          ...
          <div className="flex flex-col w-[606px] h-[730px] font-poppins mt-[200px]">
            ...
            <div>
              ...
              <div className="flex space-x-2">
                {product.sizes?.map((size) => (
                  <button
                    key={size}
                    className="w-10 h-10 rounded bg-[#F9F1E7] hover:bg-primary hover:bg-[#B88E2F] hover:text-white"
                  >
                    {size}
                  </button>
                ))}
            ...
            <div>
              <LinkSocial sku={product.sku} category={product.category} tags={product.tags ? [product.tags] : []} />
